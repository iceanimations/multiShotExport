...
class Item(Form2, Base2):
    def __init__(self, parent=None, title='', shot=None):
        ...
        self.nukeButton.clicked[bool].connect(self.handleNukeButton)
        self.hdButton.clicked[bool].connect(self.handleHdButton)
        self.fullHdButton.clicked[bool].connect(self.handleFullHdButton)
        self.jpgButton.clicked[bool].connect(self.handlJpgButton)
